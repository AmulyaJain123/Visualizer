...
import BubbleSortAnimation from "../components/bubbleSortComponents/BubbleSortAnimation";
...
export default function BubbleSort() {
  ...
  return (
    <>
      <Helmet>
        <title>Bubble Sort | AlgoTrace</title>
        <meta
          name="description"
          content="Visit the interactive Animation for Bubble Sort"
        />
      </Helmet>
      <div className="flex flex-col  select-none  w-full py-16 pt-12 px-8 h-full mb-[200px]">
        ...
        <div className="flex   mx-auto">
          <div className="flex  border-2 text-[#c08552]   border-neutral-200">
            ...
            <div className="relative flex m-1 bg-[#f3e9dc] border-2 border-[#c08552] rounded-xl justify-center items-center">
              <Go status={ready} />
              <button
        ...
        <div className="w-full h-full mt-8 flex justify-center items-center">
          {arr != null && arr != undefined && ready ? (
            <BubbleSortAnimation arr={arr} order={selectRef.current.value} />
          ) : null}
        </div>
      </div>
    </>
