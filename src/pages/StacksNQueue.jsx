...
export default function StacksNQueue() {
  return (
    <>
      <Helmet>
        <title>Stacks & Queue Overview | AlgoTrace</title>
        <meta
          name="description"
          content="Overview the Stack and Queue data structures and animation legend for deeper understanding of algorithms."
        />
      </Helmet>
