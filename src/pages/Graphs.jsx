import BellmanTemplate from "../components/overviewComponents/BellmanTemplate";
...
import FloydTemplate from "../components/overviewComponents/FloydTemplate";
import GraphsTemplate from "../components/overviewComponents/GraphTemplate";
import KruskalTemplate from "../components/overviewComponents/KruskalTemplate";
import PrimsTemplate from "../components/overviewComponents/PrimsTemplate";
  ...
  return (
    <div className="flex w-full relative overflow-auto customScroll">
      <div className="flex flex-grow flex-col ">
        ...
        <p className="text-center text-lg w-[80%] mx-auto">
          <b>NOTE:</b> For the algrithms from dijkstra to kruskal, the following
          is the structure of the <code>graph</code> parameter of the function:{" "}
        </p>
