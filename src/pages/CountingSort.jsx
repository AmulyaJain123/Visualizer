...
import CountingSortAnimation from "../components/countingSortComponents/CountingSortAnimation";
...
export default function CountingSort() {
  ...
  return (
    <>
      <Helmet>
        <title>Counting Sort | AlgoTrace</title>
        <meta
          name="description"
          content="Visit the interactive Animation for Counting Sort"
        />
      </Helmet>
      <div className="flex flex-col  select-none  w-full py-16 pt-12 px-8 h-full mb-[200px]">
          ...
          <div className="flex  border-2 text-[#c08552]   border-neutral-200">
            <div className="flex flex-col max-w-[200px]   ">
              ...
              <p className="text-sm p-1 m-1 px-3 bg-[#f3e9dc] border-2 border-[#c08552] rounded-xl">
                Enter upto 10 numbers from 0 to 10 separated by space
              </p>
            </div>
        ...
        <div className="w-full h-full mt-8 flex justify-center items-center">
          {arr != null && arr != undefined && ready ? (
            <CountingSortAnimation arr={arr} order={selectRef.current.value} />
          ) : null}
        </div>
      </div>
    </>
