...
import InsertionSortAnimation from "../components/insertionSortComponents/InsertionSortAnimation";
      ...
      <div className="flex flex-col  select-none  w-full py-12 px-8 h-full mb-[200px]">
        ...
        <div className="w-full h-full mt-8 flex justify-center items-center">
          {arr != null && arr != undefined && ready ? (
            <InsertionSortAnimation arr={arr} order={selectRef.current.value} />
          ) : null}
        </div>
      </div>
    </>
