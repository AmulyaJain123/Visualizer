import BinarySearchTreeTemplate from "../components/overviewComponents/BinarySearchTreeTemplate";
import BinaryTreeTemplate from "../components/overviewComponents/BinaryTreeTemplate";
import HeapSortTemplate from "../components/overviewComponents/HeapSortTemplate";
import HeapTemplate from "../components/overviewComponents/HeapTemplate";
...
export default function Trees() {
  return (
    <>
      <Helmet>
        <title>Trees Overview | AlgoTrace</title>
        <meta
          name="description"
          content="Overview Tree data structure and animation legend for deeper understanding of algorithms."
        />
      </Helmet>
      <div className="flex w-full relative overflow-auto customScroll">
        ...
        >
          ...
          <div className=" border-black w-[150px] divide-black flex flex-col ">
            ...
            <a className="my-1 flex-grow hover:text-[#9c6644]" href="#heap">
              Heap
            </a>
            <a className="my-1 flex-grow hover:text-[#9c6644]" href="#heapSort">
              Heap Sort
            </a>
          </div>
        </div>
