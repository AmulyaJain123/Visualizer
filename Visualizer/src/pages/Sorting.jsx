import BubbleSortTemplate from "../components/overviewComponents/BubbleSortTemplate";
import CountingSortTemplate from "../components/overviewComponents/CountingSortTemplate";
import InsertionSortTemplate from "../components/overviewComponents/InsertionSortTemplate";
import SelectionSortTemplate from "../components/overviewComponents/SelectionSortTemplate";
import MergeSortTemplate from "../components/overviewComponents/MergeSortTemplate";
import QuickSortTemplate from "../components/overviewComponents/QuickSortTemplate";
    ...
    <div className="flex w-full relative overflow-auto customScroll">
      <div className="flex flex-grow flex-col ">
        ...
        <p className="mt-2 text-lg text-center ">
          NOTE: <br /> The code and the explanation given below are for sorting
          in increasing order. Logic can be conveniently altered for decreasing
          order
        </p>
      ...
      >
        ...
        <div className=" border-black w-[150px] divide-black flex flex-col ">
          <a className="my-1 flex-grow hover:text-[#9c6644]" href="#bubbleSort">
            Bubble Sort
          </a>
          <a
          ...
          <a className="my-1 flex-grow hover:text-[#9c6644]" href="#mergeSort">
            Merge Sort
          </a>
          <a className="my-1 flex-grow hover:text-[#9c6644]" href="#quickSort">
            Quick Sort
          </a>
        </div>
      </div>
