...
export default function InsertionTree({ treeArr, found, currentNode, status }) {
                      ...
                      <div key={ind2}>
                        {j !== null ? (
                          ...
                          >
                            ...
                            ((currentNode.currx === ind1 &&
                              currentNode.curry === ind2) ||
                              (currentNode.parx === ind1 &&
                                currentNode.pary === ind2)) ? (
